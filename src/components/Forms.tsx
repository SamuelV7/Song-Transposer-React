    ...
    <div className="flex flex-row justify-center p-3">
      <form className="bg-slate-50 rounded-xl flex flex-col p-5">
        ...
        <div className="flex flex-col">
          ...
          <button
            type="button"
            className="bg-slate-900 rounded-lg p-2 hover:bg-slate-100 hover:border-2
            hover:border-slate-700 hover:text-slate-600 active:bg-slate-400 text-stone-100 text-lg"
            onClick={submit}
          >
            Press to Upload
          </button>
